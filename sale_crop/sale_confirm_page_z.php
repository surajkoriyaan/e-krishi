 ...
 <div id="ease">
       ...
       <br>
         <?php
            ...
            $qry="select * from zaid order by sl_no desc limit 1";
			$smt=mysql_query($qry);
  ...
  <div id="footer">
    ...
    <div class="wrapper">
      <div class="fleft">Copyright &copy; 2014 <a href="#">Kanchan Kumari</a> All Rights Reserved</div>
      <div class="fright">Designed by Kanchan Kumari- <a href="http://www.templatemonster.com/">Roll No. 11MCA028</a> Semester VI</div>
    </div>
  </div>
</div>
<div align=center>University Department of Mathematics, MCA Cell, Ranchi University, Ranchi Jharkhand, INDIA</div>
</body>
</html>