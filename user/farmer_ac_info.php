    ...
    <body background="../images/header-bg1.jpg">
        ...
        <div class="div_inner">     
         <?php
            ...
            $qry="select * from farmer_ac order by reg_id desc limit 1";
			$smt=mysql_query($qry);
          ...
          <center>
			...
			?> </span></center>
                <center>
				<table border="0" width="90%" cellpadding="10" cellpadding="8">
            <tr>
            ...
            <tr  bgcolor="#FFFFCC">
                 <td class="t" colspan="2" rowspan="7">  
                    <?php echo '<img height="250" width="220" src="../images//'.$result['photo'].'">';?>              
             	 </td>
             </tr>
             <tr bgcolor="#FFFFCC">
                 <td class="t">   
        ...
        <div class="div_ac_info"> 
        	<br>
                 ...
                 <br>
                 <center>
                 <a href="../auctions/farmer_login.php">
